...
class DataLoader(object):
    ...
    def __init__(
            self, data_name, data=0, load_dict=True, cuda=True, batch_size=32, shuffle=True, test=False, with_EOS=False, loadNE=True): #data = 0 for train, 1 for valid, 2 for test
